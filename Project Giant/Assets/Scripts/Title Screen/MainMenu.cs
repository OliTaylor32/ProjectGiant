...
public class MainMenu : MonoBehaviour
{
    ...
    private void SetEncyclopediaText()
    {
        ...
        articles[3] = "These inhabitants live in small communities and have their own cultures and way of live which the giant can decide to either help flurish or destroy. Currently there is only one tribe, the red tribe which can be naturally found on grasslands" + "\n" + "Regardless of the tribe, villagers have two main functions: They can build and they can make the Giant grow." + "\n" + "In order to build, the villager needs to gather materials. Sometimes they are capible of doing this on their own, however sometimes they will call for help from the giant, who can carry over the correct matierals for them to collect. Then once they find appropriate space, they will begin to build (and again they may require the giants help to make space for the new structure)." + "\n" + "When good or eveil deeds are performed by the Giant to the villagers, they will grant the Giant with a star or tear respectivly. Collect enough of either and the Giant will grow, becoming stronger and learning new abilities to influence the island further.";
